  ...
  return (
    <>
      <div className="flex p-4 bg-blue-400 justify-between items-center shadow-xl">
        <div className="text-4xl font-bold text-white">HireReady</div>
          ...
          <div className="flex flex-wrap justify-between">
            ...
            <div className="w-full sm:w-1/3 mb-6 sm:mb-0">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="https://github.com/AdityAiiitl03"
                  className="text-3xl hover:scale-125 transition-all ease-in-out"
                >
                  <FaSquareGithub />
                </a>
            ...
            <div className="w-full sm:w-1/3">
              ...
              <p>Email: ks3406800@gmail.com</p>
              <p>Phone: +91-7858937955</p>
              <p>Address: LUCKNOW, UTTAR PRADESH</p>
            </div>
          </div>
          <div className="text-center mt-8">
            <p>&copy; 2027 HireReady. All rights reserved.</p>
          </div>
        </div>
      </div>
    </>
